...
result_path = "./result/sparse_pagerank_block_stripe.txt"
...
def page_rank_block_stripe(node_num, iters=100, beta=0.85, epsilon=1e-6, dist='l1', block_max_num=1000):
    """
...
if __name__ == "__main__":
    ...
    r_new_path = page_rank_block_stripe(len(id_index_dict), iters=10)
